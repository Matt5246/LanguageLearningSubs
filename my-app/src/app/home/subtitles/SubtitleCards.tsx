...
export function SubtitleCards({ groupedSubtitles }: { groupedSubtitles: GroupedSubtitles }) {
    ...
    return (
        <div className="columns-1 sm:columns-2 md:columns-3 lg:columns-4 xl:columns-5 2xl:columns-6 4xl:columns-7  gap-4 space-y-4 mt-5 ">
            {Object.entries(groupedSubtitles).map(([title, subtitles]) => (
                <div
                    key={title}
                    className='break-inside-avoid transition-all duration-300 ease-in-out w-[250px]'
                >
